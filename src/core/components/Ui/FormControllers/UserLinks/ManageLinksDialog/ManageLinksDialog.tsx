...
export const ManageLinksDialog: FC<ManageLinksDialogProps> = memo(({ open, onClose, links }) => {
    ...
    return (
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm" slotProps={{ paper: { component: "form" } }}>
            ...
            <Activity mode={view === "list" ? "visible" : "hidden"}>
                ...
                <DialogActions>
                    ...
                    <Button variant="contained" startIcon={<AddLinkIcon />} onClick={handleOpenCreate}>
                        Add New Link
                    </Button>
                </DialogActions>
            </Activity>
